	 ...
	 if(isset($_POST['edit']))
            {
                ...
                $sql = "SELECT * FROM customerdata WHERE Matrix_No='$Matrix_No' ";
               ...
               <th>Matrix No</th>
                ...
                <th>Confirm Password</th>
                 <th>User Type</th>
                	...
                	<tr>
                	<td><input name="matrixNo" class="input" value="<?php echo $row['Matrix_No'] ?>" type="number" maxlength="7" placeholder="Enter your matrix number" required></td>
                	<td><input name="name" class="input" value="<?php echo $row['name'] ?>" type="text" placeholder="Enter your name" required></td>
                	<td><input name="telephone" class="input" value="<?php echo $row['telephone'] ?>" type="tel" placeholder="Enter your phone number" required></td>
                	<td><input name="email" class="input" value="<?php echo $row['email'] ?>" type="email" placeholder="Enter your email" required></td>
                	<td><input name="password1" class="input" value="<?php echo $row['password1'] ?>" type="text" minlength="8" placeholder="Enter your password" required></td>
                	<td><input name="password2" class="input" value="<?php echo $row['password2'] ?>" type="text" minlength="8"  placeholder="Confirm your password" required></td>
                	<td><input name="usertype" class="input" value="<?php echo $row['usertype'] ?>" type="text" minlength="8"  placeholder="user type" required></td>
                	</tr>
                    </table>
                    <div class="lastBtn">
                	<button type="submit" name="updatebtn" href="databaseAdmin" class="butang2"> Cancel </button>
                            <button type="submit" name="updatebtn" class="butang1"> Update </button>
                        </div>
                }
      		<?php
      	}
